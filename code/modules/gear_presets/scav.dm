...
/datum/equipment_preset/scav/rifle/elite/load_gear(mob/living/carbon/human/new_human)
	...
	switch(scav_weapon)
		if(1)
			...
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/ar10(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/ar10(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/ar10(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/ar10(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/ar10(new_human), WEAR_IN_WAIST)
		if(2)
			new_human.equip_to_slot_or_del(new /obj/item/storage/belt/marine, WEAR_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m16(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m16(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m16(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m16(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m16(new_human), WEAR_IN_WAIST)
		if(3)
			...
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/rmc_f90(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/rmc_f90(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/rmc_f90(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/rmc_f90(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/rmc_f90(new_human), WEAR_IN_WAIST)
		if(4)
			new_human.equip_to_slot_or_del(new /obj/item/storage/belt/marine, WEAR_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m20a(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m20a(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m20a(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m20a(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/m20a(new_human), WEAR_IN_WAIST)
		if(5)
			...
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/lw317(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/lw317(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/lw317(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/lw317(new_human), WEAR_IN_WAIST)
			new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/rifle/lw317(new_human), WEAR_IN_WAIST)
